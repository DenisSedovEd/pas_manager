import { Ar as parseStringStyle, Cr as isString, Er as makeMap, Fr as __commonJSMin, Ir as __esmMin, Lr as __exportAll, Mr as slotFlagsText, Pr as toHandlerKey, Rr as __toCommonJS, Sr as isSVGTag, Tr as isVoidTag, _r as isHTMLTag, br as isOn, cr as NOOP, dr as capitalize, fr as extend$1, gr as isBuiltInDirective, hr as isArray, jr as shared_esm_bundler_exports, lr as PatchFlagNames, m as runtime_dom_esm_bundler_exports, mr as init_shared_esm_bundler, or as EMPTY_OBJ, pr as generateCodeFrame, sr as NO, u as init_runtime_dom_esm_bundler, ur as camelize, vr as isMathMLTag, wr as isSymbol, xr as isReservedProp, yr as isObject } from "./runtime-dom.esm-bundler-CtBCU7J0.js";
...
function onCloseTag(el, end, isImplied = false) {
	...
	if (tokenizer.inSFCRoot) {
		if (el.children.length) el.innerLoc.end = extend$1({}, el.children[el.children.length - 1].loc.end);
		else el.innerLoc.end = extend$1({}, el.innerLoc.start);
...
function baseCompile(source, options = {}) {
	...
	const resolvedOptions = extend$1({}, options, { prefixIdentifiers });
...
var init_compiler_core_esm_bundler = __esmMin((() => {
	...
	SUSPENSE = /* @__PURE__ */ Symbol(`Suspense`);
	KEEP_ALIVE = /* @__PURE__ */ Symbol(`KeepAlive`);
	BASE_TRANSITION = /* @__PURE__ */ Symbol(`BaseTransition`);
	OPEN_BLOCK = /* @__PURE__ */ Symbol(`openBlock`);
	CREATE_BLOCK = /* @__PURE__ */ Symbol(`createBlock`);
	CREATE_ELEMENT_BLOCK = /* @__PURE__ */ Symbol(`createElementBlock`);
	CREATE_VNODE = /* @__PURE__ */ Symbol(`createVNode`);
	CREATE_ELEMENT_VNODE = /* @__PURE__ */ Symbol(`createElementVNode`);
	CREATE_COMMENT = /* @__PURE__ */ Symbol(`createCommentVNode`);
	CREATE_TEXT = /* @__PURE__ */ Symbol(`createTextVNode`);
	CREATE_STATIC = /* @__PURE__ */ Symbol(`createStaticVNode`);
	RESOLVE_COMPONENT = /* @__PURE__ */ Symbol(`resolveComponent`);
	RESOLVE_DYNAMIC_COMPONENT = /* @__PURE__ */ Symbol(`resolveDynamicComponent`);
	RESOLVE_DIRECTIVE = /* @__PURE__ */ Symbol(`resolveDirective`);
	RESOLVE_FILTER = /* @__PURE__ */ Symbol(`resolveFilter`);
	WITH_DIRECTIVES = /* @__PURE__ */ Symbol(`withDirectives`);
	RENDER_LIST = /* @__PURE__ */ Symbol(`renderList`);
	RENDER_SLOT = /* @__PURE__ */ Symbol(`renderSlot`);
	CREATE_SLOTS = /* @__PURE__ */ Symbol(`createSlots`);
	TO_DISPLAY_STRING = /* @__PURE__ */ Symbol(`toDisplayString`);
	MERGE_PROPS = /* @__PURE__ */ Symbol(`mergeProps`);
	NORMALIZE_CLASS = /* @__PURE__ */ Symbol(`normalizeClass`);
	NORMALIZE_STYLE = /* @__PURE__ */ Symbol(`normalizeStyle`);
	NORMALIZE_PROPS = /* @__PURE__ */ Symbol(`normalizeProps`);
	GUARD_REACTIVE_PROPS = /* @__PURE__ */ Symbol(`guardReactiveProps`);
	TO_HANDLERS = /* @__PURE__ */ Symbol(`toHandlers`);
	CAMELIZE = /* @__PURE__ */ Symbol(`camelize`);
	CAPITALIZE = /* @__PURE__ */ Symbol(`capitalize`);
	TO_HANDLER_KEY = /* @__PURE__ */ Symbol(`toHandlerKey`);
	SET_BLOCK_TRACKING = /* @__PURE__ */ Symbol(`setBlockTracking`);
	PUSH_SCOPE_ID = /* @__PURE__ */ Symbol(`pushScopeId`);
	POP_SCOPE_ID = /* @__PURE__ */ Symbol(`popScopeId`);
	WITH_CTX = /* @__PURE__ */ Symbol(`withCtx`);
	UNREF = /* @__PURE__ */ Symbol(`unref`);
	IS_REF = /* @__PURE__ */ Symbol(`isRef`);
	WITH_MEMO = /* @__PURE__ */ Symbol(`withMemo`);
	IS_MEMO_SAME = /* @__PURE__ */ Symbol(`isMemoSame`);
	helperNameMap = {
		[FRAGMENT]: `Fragment`,
		[TELEPORT]: `Teleport`,
		[SUSPENSE]: `Suspense`,
...
Use a v-bind binding combined with a v-on listener that emits update:x event instead.`,
	...
	transformOn$1 = (dir, node, context, augmentor) => {
...
var init_compiler_dom_esm_bundler = __esmMin((() => {
	...
	init_compiler_core_esm_bundler();
	init_shared_esm_bundler();
	V_MODEL_RADIO = /* @__PURE__ */ Symbol(`vModelRadio`);
	V_MODEL_CHECKBOX = /* @__PURE__ */ Symbol(`vModelCheckbox`);
	V_MODEL_TEXT = /* @__PURE__ */ Symbol(`vModelText`);
	V_MODEL_SELECT = /* @__PURE__ */ Symbol(`vModelSelect`);
	V_MODEL_DYNAMIC = /* @__PURE__ */ Symbol(`vModelDynamic`);
	V_ON_WITH_MODIFIERS = /* @__PURE__ */ Symbol(`vOnModifiersGuard`);
	V_ON_WITH_KEYS = /* @__PURE__ */ Symbol(`vOnKeysGuard`);
	V_SHOW = /* @__PURE__ */ Symbol(`vShow`);
	TRANSITION = /* @__PURE__ */ Symbol(`Transition`);
	TRANSITION_GROUP = /* @__PURE__ */ Symbol(`TransitionGroup`);
	...
	DOMNodeTransforms = [transformStyle, ...[transformTransition, validateHtmlNesting]];
